...
//   , o = e=>{
//     const t = async(t,n={})=>fetch(`https://api.giphy.com/v1/gifs/${t}?${new URLSearchParams({
//         lang: e,
//         limit: "20",
//         rating: "g",
//         api_key: "6CIMLkNMMOhRcXPoMCPkFy4Ybk2XUiMp",
//         ...n
//     }).toString()}`).then((e=>e.json())).then((({data: e})=>e.map((e=>({
//         title: e.title,
...
//         if (r)
//             return `<span style="color: slategray">${r}</span>`;
//         if ("<" === n)
//             return "&lt;";
//         let l;
//         u[n] ? l = u[n] : (l = c[t],
...
//   , w = h(["暱稱", "暱稱不能少於3個字元", "郵箱", "請填寫正確的郵件地址", "網址", "可選", "歡迎留言", "來發留言吧~", "送出", "喜歡", "取消喜歡", "回覆", "取消回覆", "留言", "重整", "載入更多...", "預覽", "表情", "上傳圖片", "秒前", "分鐘前", "小時前", "天前", "剛剛", "正在上傳", "登入", "登出", "管理者", "置頂", "字", "留言字數應在 $0 到 $1 字之間！\n目前字數：$2", "匿名", "潛水", "冒泡", "吐槽", "活躍", "多話", "傳說", "表情包", "搜尋表情包", "個人資料", "通過", "待審核", "垃圾", "取消置頂", "最早", "最新", "熱門", "你認為這篇文章怎麼樣？"]);
// const k = {
//     zh: y,
//     "zh-cn": y,
//     "zh-CN": y,
...
//     return e
// }
//   , _ = ({serverURL: e, lang: t, paths: n, type: r, signal: l})=>fetch(`${e}/article?path=${encodeURIComponent(n.join(","))}&type=${encodeURIComponent(r.join(","))}&lang=${t}`, {
//     signal: l
// }).then((e=>e.json()))
//   , $ = ({serverURL: e, lang: t, path: n, type: r, action: l})=>fetch(`${e}/article?lang=${t}`, {
//     method: "POST",
//     headers: b,
//     body: JSON.stringify({
//         path: n,
...
//     })
// }).then((e=>e.json()))
//   , C = ({serverURL: e, lang: t, token: n, objectId: r, comment: l})=>fetch(`${e}/comment/${r}?lang=${t}`, {
//     method: "PUT",
//     headers: {
//         ...b,
...
// }).then((e=>e.json())).then((e=>x(e, "Update comment")))
//   , S = e=>{
//     try {
//         e = decodeURI(e)
//     } catch (e) {}
...
// ;
// let ke;
// const be = ()=>ke || (ke = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : {});
// function xe(e) {
//     if (K(e)) {
//         const t = {};
//         for (let n = 0; n < e.length; n++) {
...
// function Se(e) {
//     const t = {};
//     return e.replace(Ce, "").split(_e).forEach((e=>{
//         if (e) {
//             const n = e.split($e);
...
//   , Te = (e,t)=>t && t.__v_isRef ? Te(e, t.value) : G(t) ? {
...
//     }
//     stop() {
//         Be === this ? this.deferStop = !0 : this.active && (Ke(this),
...
//         ))
//     } else
//         switch (void 0 !== n && o.push(s.get(n)),
//         t) {
//         case "add":
//             K(e) ? oe(n) && o.push(s.get("length")) : (o.push(s.get(We)),
//             G(e) && o.push(s.get(qe)));
//             break;
//         case "delete":
//             K(e) || (o.push(s.get(We)),
...
//   , it = new Set(Object.getOwnPropertyNames(Symbol).filter((e=>"arguments" !== e && "caller" !== e)).map((e=>Symbol[e])).filter(ee))
//   , st = dt()
//   , ot = dt(!1, !0)
//   , at = dt(!0)
//   , ct = ut();
...
//         if (!e) {
//             if (i && Z(ct, r))
//                 return Reflect.get(ct, r, l);
//             if ("hasOwnProperty" === r)
//                 return pt
//         }
//         const s = Reflect.get(n, r, l);
//         return (ee(r) ? it.has(r) : lt(r)) ? s : (e || Ye(n, 0, r),
//         t ? s : tn(s) ? i && oe(r) ? s : s.value : te(s) ? e ? Ht(s) : Dt(s) : s)
//     }
// }
// function ht(e=!1) {
...
//         return t === Gt(l) && (s ? me(r, i) && tt(t, "set", n, r) : tt(t, "add", n, r)),
//         o
//     }
// }
// const ft = {
...
//         return ee(t) && it.has(t) || Ye(e, 0, t),
//         n
//     },
//     ownKeys: function(e) {
//         return Ye(e, 0, K(e) ? "length" : We),
//         Reflect.ownKeys(e)
//     }
// }
//   , gt = {
...
//     const s = l.call(n, e);
//     return n.set(e, t),
//     i ? me(t, s) && tt(n, "set", e, t) : tt(n, "add", e, t),
//     this
// }
// function $t(e) {
//     const t = Gt(this)
...
//           , o = t ? vt : e ? Xt : Jt;
//         return !e && Ye(s, 0, We),
//         i.forEach(((e,t)=>n.call(r, o(e), o(t), l)))
//     }
// }
// function At(e, t, n) {
//     return function(...r) {
...
//     if (i)
//         return i;
//     const s = (o = e).__v_skip || !Object.isExtensible(o) ? 0 : function(e) {
//         switch (e) {
//         case "Object":
//         case "Array":
//             return 1;
...
//         e = t ? e : Gt(e),
//         me(e, this._rawValue) && (this._rawValue = e,
//         this._value = t ? e : Jt(e),
//         en(this))
//     }
// }
...
//         if (s)
//             return void pn(s, null, 10, [e, l, i])
//     }
//     !function(e, t, n, r=!0) {
//         console.error(e)
//     }(e, 0, 0, r)
...
//         if (yn.length = 0,
//         wn)
//             return void wn.push(...e);
//         for (wn = e,
//         wn.sort(((e,t)=>Rn(e) - Rn(t))),
//         kn = 0; kn < wn.length; kn++)
//             wn[kn]();
//         wn = null,
//         kn = 0
//     }
...
//     const i = e.emits;
//     let s = {};
//     return i ? (K(i) ? i.forEach((e=>s[e] = null)) : B(s, i),
//     te(e) && r.set(e, s),
//     s) : (te(e) && r.set(e, null),
//     null)
// }
...
//     const t = jn;
//     return jn = e,
//     On = e && e.type.__scopeId || null,
//     t
// }
// function Mn(e) {
//     const {type: t, vnode: n, proxy: r, withProxy: l, props: i, propsOptions: [s], slots: o, attrs: a, emit: c, render: u, renderCache: p, data: d, setupState: h, ctx: f, inheritAttrs: g} = e;
//     let m, v;
//     const y = Un(e);
//     try {
//         if (4 & n.shapeFlag) {
//             const e = l || r;
//             m = pl(u.call(e, e, p, i, h, d, f)),
//             v = a
//         } else {
//             const e = t;
//             m = pl(e.length > 1 ? e(i, {
...
//           , {shapeFlag: t} = w;
//         e.length && 7 & t && (s && e.some(H) && (v = Fn(v, s)),
//         w = al(w, v))
//     }
//     return n.dirs && (w = al(w),
...
//     c = ()=>e.map((e=>tn(e) ? e.value : Wt(e) ? Wn(e) : X(e) ? pn(e, a, 2) : void 0))) : c = X(e) ? t ? ()=>pn(e, a, 2) : ()=>{
//         if (!a || !a.isUnmounted)
//             return u && u(),
//             dn(e, a, 3, [f])
//     }
...
//             if (t) {
//                 const e = y.run();
//                 (r || p || (d ? e.some(((e,t)=>me(e, g[t]))) : me(e, g))) && (u && u(),
...
//     let v;
//     m.allowRecurse = !!t,
//     "sync" === l ? v = m : "post" === l ? v = ()=>Fr(m, a && a.suspense) : (m.pre = !0,
//     a && (m.id = a.uid),
//     v = ()=>$n(m));
//     const y = new Ze(c,v);
...
//         u(e)) : (p = o.__cssModules) && (p = p[t]) ? p : n !== M && Z(n, t) ? (s[t] = 4,
...
//         return ar(l, t) ? (l[t] = n,
//         !0) : r !== M && Z(r, t) ? (r[t] = n,
//         !0) : !Z(e.props, t) && (("$" !== t[0] || !(t.slice(1)in e)) && (i[t] = n,
//         !0))
//     },
...
//         return null != n.get ? e._.accessCache[t] = 0 : Z(n, "value") && this.set(e, t, n.value, null),
//         Reflect.defineProperty(e, t, n)
//     }
// };
// function ur(e) {
//     return K(e) ? e.reduce(((e,t)=>(e[t] = null,
//     e)), {}) : e
// }
// function pr(e, t, n, r=!1) {
//     const {mixins: l, extends: i} = t;
//     i && pr(e, i, n, !0),
//     l && l.forEach((t=>pr(e, t, n, !0)));
//     for (const l in t)
//         if (r && "expose" === l)
//             ;
//         else {
...
//             },
//             set config(e) {},
//             use: (e,...t)=>(i.has(e) || (e && X(e.install) ? (i.add(e),
//             e.install(o, ...t)) : X(e) && (i.add(e),
//             e(o, ...t))),
//             o),
//             mixin: e=>o,
...
//         t in l || (l[t] = void 0);
//     n ? e.props = r ? l : Bt(l, !1, mt, Ut, Ft) : e.type.props ? e.props = l : e.props = i,
//     e.attrs = i
// }
// function $r(e, t, n, r) {
...
//             const c = t[a];
//             let u;
//             l && Z(l, u = pe(a)) ? i && i.includes(u) ? (s || (s = {}))[u] = c : n[u] = c : Tn(e.emitsOptions, a) || a in r && c === r[a] || (r[a] = c,
//             o = !0)
//         }
//     if (i) {
//         const t = Gt(n)
...
//       , p = o.setupState;
//     if (null != c && c !== a && (Y(c) ? (u[c] = null,
//     Z(p, c) && (p[c] = null)) : tn(c) && (c.value = null)),
//     X(a))
//         pn(a, o, 12, [s, u]);
//     else {
//         const t = Y(a)
...
//                     l ? K(n) && W(n, i) : K(n) ? n.includes(i) || n.push(i) : t ? (u[a] = [i],
//                     Z(p, a) && (p[a] = u[a])) : (a.value = [i],
//                     e.k && (u[e.k] = a.value))
//                 } else
//                     t ? (u[a] = s,
//                     Z(p, a) && (p[a] = s)) : r && (a.value = s,
//                     e.k && (u[e.k] = s))
//             }
//             ;
//             s ? (o.id = -1,
...
//     var n;
//     t && t.pendingBranch ? K(e) ? t.effects.push(...e) : t.effects.push(e) : (K(n = e) ? yn.push(...n) : wn && wn.includes(n, n.allowRecurse ? kn + 1 : kn) || yn.push(n),
//     Cn())
// };
// function Vr(e) {
//     return function(e, t) {
//         be().__VUE__ = !0;
//         const {insert: n, remove: r, patchProp: l, createElement: i, createText: s, createComment: o, setText: a, setElementText: c, parentNode: u, nextSibling: p, setScopeId: d=F, insertStaticContent: h} = e
...
//             w && v.beforeEnter(d),
//             n(d, t, r),
//             ((h = g && g.onVnodeMounted) || w || y) && Fr((()=>{
//                 h && fl(h, s, e),
//                 w && v.enter(d),
//                 y && Zn(e, null, s, "mounted")
//             }
//             ), o)
//         }
//           , x = (e,t,n,r,l)=>{
...
//             if (p ? C(e.dynamicChildren, p, a, n, r, m, s) : o || T(e, t, a, null, n, r, m, s, !1),
//             u > 0) {
//                 if (16 & u)
//                     S(a, t, h, f, n, r, i);
//                 else if (2 & u && h.class !== f.class && l(a, "class", null, f.class, i),
...
//             null == e ? (n(p, r, l),
//             n(d, r, l),
//             _(t.children, r, d, i, o, a, c, u)) : h > 0 && 64 & h && f && e.dynamicChildren ? (C(e.dynamicChildren, f, r, i, o, a, c),
//             (null != t.key || i && t === i.subTree) && Dr(e, t, !0)) : T(e, t, r, d, i, o, a, c, u)
//         }
//           , R = (e,t,n,r,l,i,s,o,a)=>{
//             t.slotScopeIds = o,
//             null == e ? 512 & t.shapeFlag ? l.ctx.activate(t, n, r, s, a) : E(t, n, r, l, i, s, a) : z(e, t, a)
//         }
//           , E = (e,t,n,r,l,i,s)=>{
...
//                     return !0;
//                 if (!(n && a >= 0))
//                     return !(!l && !o || o && o.$stable) || r !== s && (r ? !s || Vn(r, s, c) : !!s);
//                 if (1024 & a)
//                     return !0;
//                 if (16 & a)
//                     return r ? Vn(r, s, c) : !!s;
...
//             const o = ()=>{
//                 if (e.isMounted) {
//                     let t, {next: n, bu: r, u: o, parent: a, vnode: c} = e, p = n;
//                     Nr(e, !1),
//                     n ? (n.el = c.el,
//                     I(e, n, s)) : n = c,
//                     r && ve(r),
...
//                     }
//                     if (u && Fr(u, l),
//                     !d && (s = a && a.onVnodeMounted)) {
//                         const e = t;
//                         Fr((()=>fl(s, p, e)), l)
//                     }
//                     (256 & t.shapeFlag || p && Gn(p.vnode) && 256 & p.vnode.shapeFlag) && e.a && Fr(e.a, l),
//                     e.isMounted = !0,
//                     t = n = r = null
//                 }
//             }
...
//             e.next = null,
//             function(e, t, n, r) {
//                 const {props: l, attrs: i, vnode: {patchFlag: s}} = e
//                   , o = Gt(l)
//                   , [a] = e.propsOptions;
//                 let c = !1;
//                 if (!(r || s > 0) || 16 & s) {
...
//                     $r(e, t, l, i) && (c = !0);
//                     for (const i in o)
//                         t && (Z(t, i) || (r = he(i)) !== i && Z(t, r)) || (a ? !n || void 0 === n[i] && void 0 === n[r] || (l[i] = Cr(a, o, i, void 0, e, !0)) : delete l[i]);
//                     if (i !== o)
//                         for (const e in i)
//                             t && Z(t, e) || (delete i[e],
//                             c = !0)
...
//             if (h > 0) {
//                 if (128 & h)
//                     return void O(u, d, n, r, l, i, s, o, a);
//                 if (256 & h)
//                     return void j(u, d, n, r, l, i, s, o, a)
//             }
//             8 & f ? (16 & p && B(u, l, i),
//             d !== u && c(n, d)) : 16 & p ? 16 & f ? O(u, d, n, r, l, i, s, o, a) : B(u, l, i, !0) : (8 & p && c(n, ""),
//             16 & f && _(d, n, r, l, i, s, o, a))
//         }
//           , j = (e,t,n,r,l,i,s,o,a)=>{
//             t = t || P;
...
//                                 break
//                             }
//                     void 0 === u ? V(r, l, i, !0) : (x[u - g] = c + 1,
//                     u >= b ? b = u : k = !0,
//                     f(r, t[u], n, null, l, i, s, o, a),
//                     y++)
//                 }
//                 const _ = k ? function(e) {
//                     const t = e.slice()
//                       , n = [0];
//                     let r, l, i, s, o;
//                     const a = e.length;
...
//             if (6 & u)
//                 return void U(e.component.subTree, t, r, l);
//             if (128 & u)
//                 return void e.suspense.move(t, r, l);
//             if (64 & u)
//                 return void o.move(e, t, r, K);
//             if (o === Hr) {
//                 n(s, t, r);
...
//             if (null != o && Pr(o, null, n, e, !0),
//             256 & u)
//                 return void t.ctx.deactivate(e);
//             const h = 1 & u && d
//               , f = !Gn(e);
//             let g;
//             if (f && (g = s && s.onVnodeBeforeUnmount) && fl(g, t, e),
//             6 & u)
//                 H(e.component, n, r);
//             else {
//                 if (128 & u)
...
//                 64 & u ? e.type.remove(e, t, n, l, K, r) : c && (i !== Hr || p > 0 && 64 & p) ? B(c, t, n, !1, !0) : (i === Hr && 384 & p || !l && 16 & u) && B(a, t, n),
//                 r && N(e)
//             }
...
//           , q = (e,t,n)=>{
//             null == e ? t._vnode && V(t._vnode, null, null, !0) : f(t._vnode || null, e, t, null, null, null, n),
//             Sn(),
//             An(),
//             t._vnode = e
//         }
...
//             const t = r[e];
//             let i = l[e];
//             1 & i.shapeFlag && !i.dynamicChildren && ((i.patchFlag <= 0 || 32 === i.patchFlag) && (i = l[e] = dl(l[e]),
//             i.el = t.el),
//             n || Dr(t, i)),
//             i.type === Br && (i.el = t.el)
//         }
...
// }
// function Xr(e) {
//     return e.dynamicChildren = Qr > 0 ? Kr || P : null,
//     Zr.pop(),
...
//   , il = ({ref: e, ref_key: t, ref_for: n})=>("number" == typeof e && (e = "" + e),
// null != e ? Y(e) || tn(e) || X(e) ? {
//     i: jn,
//     r: e,
//     k: t,
...
//     };
//     return o ? (hl(a, n),
//     128 & i && e.normalize(a)) : n && (a.shapeFlag |= Y(n) ? 8 : 16),
...
//         const r = al(e, t, !0);
//         return n && hl(r, n),
//         Qr > 0 && !i && Kr && (6 & r.shapeFlag ? Kr[Kr.indexOf(e)] = r : Kr.push(r)),
//         r.patchFlag |= -2,
//         r
//     }
//     s = e,
//     X(s) && "__vccOpts"in s && (e = e.__vccOpts);
//     var s;
//     if (t) {
//         t = function(e) {
...
//             n = 32;
//             const r = t._;
//             r || rl in t ? 3 === r && jn && (1 === jn.slots._ ? t._ = 1 : (t._ = 2,
//             e.patchFlag |= 1024)) : t._ctx = jn
//         }
//     } else
//         X(t) ? (t = {
//             default: t,
...
// let vl = null;
// const yl = ()=>vl || jn;
// let wl, kl, bl = "__VUE_INSTANCE_SETTERS__";
// (kl = be()[bl]) || (kl = be()[bl] = []),
// kl.push((e=>vl = e)),
// wl = e=>{
...
// let Cl, Sl = !1;
// function Al(e, t, n) {
//     X(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : te(t) && (e.setupState = cn(t)),
//     Rl(e, n)
// }
// function Rl(e, t, n) {
//     const r = e.type;
...
//                   , {mixins: l, optionsCache: i, config: {optionMergeStrategies: s}} = e.appContext
//                   , o = i.get(t);
//                 let a;
//                 return o ? a = o : l.length || n || r ? (a = {},
...
// function El(e) {
//     if (e.exposed)
//         return e.exposeProxy || (e.exposeProxy = new Proxy(cn(Qt(e.exposed)),{
...
//     return 2 === r ? te(t) && !K(t) ? tl(t) ? ol(e, null, [t]) : ol(e, t) : ol(e, null, t) : (r > 3 ? n = Array.prototype.slice.call(arguments, 2) : 3 === r && tl(n) && (n = [n]),
//     ol(e, t, n))
// }
...
//         const l = t ? Ol.createElementNS("http://www.w3.org/2000/svg", e) : Ol.createElement(e, n ? {
//             is: n
//         } : void 0);
//         return "select" === e && r && null != r.multiple && l.setAttribute("multiple", r.multiple),
//         l
//     }
//     ,
...
//             for (; t.insertBefore(l.cloneNode(!0), n),
//             l !== i && (l = l.nextSibling); )
//                 ;
//         else {
...
//             if (r && e.value.trim() === t)
//                 return;
//             if ((l || "number" === e.type) && we(e.value) === t)
//                 return
//         }
//         const s = null == t ? "" : t;
//         e.value !== s && (e.value = s)
...
//     e._modelValue = t,
//     K(t) ? e.checked = Le(t, r.props.value) > -1 : Q(t) ? e.checked = t.has(r.props.value) : t !== n && (e.checked = ze(t, si(e, !0)))
// }
// const ni = {
//     created(e, {value: t}, n) {
...
//         e._assign = Ql(r),
//         t !== n && (e.checked = ze(t, r.props.value))
//     }
// }
//   , ri = {
//     deep: !0,
...
//               , i = ii(l);
//             if (n)
//                 K(t) ? l.selected = Le(t, i) > -1 : l.selected = t.has(i);
//             else if (ze(ii(l), t))
...
//             }
//         }(e, n, r) : D(t) ? H(t) || Bl(e, t, 0, r, s) : ("." === t[0] ? (t = t.slice(1),
//         1) : "^" === t[0] ? (t = t.slice(1),
//         0) : function(e, t, n, r) {
//             if (r)
//                 return "innerHTML" === t || "textContent" === t || !!(t in e && Gl.test(t) && X(n));
...
//                 e._value = n;
//                 const r = null == n ? "" : n;
//                 return ("OPTION" === o ? e.getAttribute("value") : e.value) !== r && (e.value = r),
//                 void (null == n && e.removeAttribute(t))
//             }
//             let a = !1;
//             if ("" === n || null == n) {
//                 const r = typeof e[t];
//                 "boolean" === r ? n = Ee(n) : null == n && "string" === r ? (n = "",
//                 a = !0) : "number" === r && (n = 0,
//                 a = !0)
//             }
//             try {
...
//         }(e, t, r, i, s, o, a) : ("true-value" === t ? e._trueValue = r : "false-value" === t && (e._falseValue = r),
//         function(e, t, n, r, l) {
...
//               , a = gi(t.maxWait);
//             return n && i(n),
//             o <= 0 || void 0 !== a && a <= 0 ? (r && (i(r),
//             r = null),
//             Promise.resolve(s())) : new Promise(((e,c)=>{
...
//       , {eventFilter: i, pause: s, resume: o, isActive: a} = function(e=bi) {
//         const t = nn(!0);
//         return {
//             isActive: Ht(t),
//             pause: function() {
...
// function Ri(...e) {
//     let t, n, r, l;
//     if ("string" == typeof e[0] || Array.isArray(e[0]) ? ([n,r,l] = e,
//     t = Si) : [t,n,r,l] = e,
//     !t)
//         return wi;
//     Array.isArray(n) || (n = [n]),
...
//         ()=>e.removeEventListener(t, n, r)))(e, t, n, l))))))
//     }
//     ), {
//         immediate: !0,
//         flush: "post"
...
//     a
// }
// const Ei = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}
//   , zi = "__vueuse_ssr_handlers__"
//   , Li = Ii();
// function Ii() {
//     return zi in Ei || (Ei[zi] = Ei[zi] || {}),
//     Ei[zi]
// }
// const Ti = {
//     boolean: {
...
// function Oi(e, t, n, r={}) {
//     var l;
//     const {flush: i="pre", deep: s=!0, listenToStorageChanges: o=!0, writeDefaults: a=!0, mergeDefaults: c=!1, shallow: u, window: p=Si, eventFilter: d, onError: h=(e=>{
//         console.error(e)
//     }
//     )} = r
//       , f = (u ? rn : nn)(t);
...
//       , {pause: y, resume: w} = _i(f, (()=>function(t) {
//         try {
//             if (null == t)
//                 n.removeItem(e);
//             else {
...
//                   , l = n.getItem(e);
//                 l !== r && (n.setItem(e, r),
//                 p && p.dispatchEvent(new CustomEvent(ji,{
//                     detail: {
//                         key: e,
//                         oldValue: l,
//                         newValue: r,
...
//                 y();
//                 try {
//                     (null == t ? void 0 : t.newValue) !== v.write(f.value) && (f.value = function(t) {
//                         const r = t ? t.newValue : n.getItem(e);
//                         if (null == r)
//                             return a && null !== g && n.setItem(e, v.write(g)),
//                             g;
//                         if (!t && c) {
//                             const e = v.read(r);
//                             return "function" == typeof c ? c(e, g) : "object" !== m || Array.isArray(e) ? e : {
//                                 ...g,
//                                 ...e
//                             }
//                         }
...
//       , r = nn(new Date)
//       , l = ()=>r.value = new Date
//       , i = "requestAnimationFrame" === n ? function(e, t={}) {
...
//         function c() {
//             l.value = !1,
//             null != s && r && (r.cancelAnimationFrame(s),
//             s = null)
//         }
//         return n && a(),
//         fi(c),
...
//         }
//         r && mi && c(),
//         (tn(t) || "function" == typeof t) && fi(Hn(t, (()=>{
//             s.value && mi && c()
//         }
//         )));
//         return fi(a),
...
//     const {immediate: r=!0, manual: l=!1, type: i="text/javascript", async: s=!0, crossOrigin: o, referrerPolicy: a, noModule: c, defer: u, document: p=Ai, attrs: d={}} = n
//       , h = nn(null);
//     let f = null;
...
//         m ? m.hasAttribute("data-loaded") && f(m) : (m = p.createElement("script"),
//         m.type = i,
//         m.async = s,
//         m.src = gi(e),
//         u && (m.defer = u),
...
//     if (t) {
//         if (Zi.test(e))
//             return e.replace(Ki, Xi)
//     } else if (Gi.test(e))
//         return e.replace(Qi, Xi);
//     return e
// }
// const es = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
// function ts(e) {
//     return e.replace(es, ((e,t)=>"colon" === (t = t.toLowerCase()) ? ":" : "#" === t.charAt(0) ? "x" === t.charAt(1) ? String.fromCharCode(parseInt(t.substring(2), 16)) : String.fromCharCode(+t.substring(1)) : ""))
// }
// const ns = /(^|[^\[])\^/g;
// function rs(e, t) {
...
//     t = t || "";
//     const n = {
//         replace: (t,r)=>(r = (r = r.source || r).replace(ns, "$1"),
//         e = e.replace(t, r),
//         n),
...
//             for (; e && (h = !1,
//             t = v.exec(e)) && !this.rules.block.hr.test(e); ) {
//                 if (n = t[0],
//                 e = e.substring(n.length),
//                 c = t[2].split("\n", 1)[0].replace(/^\t+/, (e=>" ".repeat(3 * e.length))),
//                 u = e.split("\n", 1)[0],
//                 this.options.pedantic ? (i = 2,
//                 d = c.trimLeft()) : (i = t[2].search(/[^ ]/),
//                 i = i > 4 ? 1 : i,
//                 d = c.slice(i),
//                 i += t[1].length),
//                 o = !1,
...
//                     !l.test(u)) && !s.test(u) && !t.test(u) && !r.test(e); ) {
...
//                 for (s = e.rows.length,
//                 n = 0; n < s; n++)
//                     e.rows[n] = ds(e.rows[n], e.header.length).map((e=>({
//                         text: e
//                     })));
...
//         if (n) {
//             let e, r;
//             return "@" === n[2] ? (e = Yi(this.options.mangle ? t(n[1]) : n[1]),
//             r = "mailto:" + e) : (e = Yi(n[1]),
//             r = e),
//             {
//                 type: "link",
...
//             let e, r;
//             if ("@" === n[2])
//                 e = Yi(this.options.mangle ? t(n[0]) : n[0]),
//                 r = "mailto:" + e;
//             else {
//                 let t;
//                 do {
...
//         if (n) {
//             let e;
//             return e = this.lexer.state.inRawBlock ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(n[0]) : Yi(n[0]) : n[0] : Yi(this.options.smartypants ? t(n[0]) : n[0]),
//             {
//                 type: "text",
//                 raw: n[0],
//                 text: e
...
// vs.bullet = /(?:[*+-]|\d{1,9}[.)])/,
// vs.listItemStart = rs(/^( *)(bull) */).replace("bull", vs.bullet).getRegex(),
// vs.list = rs(vs.list).replace(/bull/g, vs.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + vs.def.source + ")").getRegex(),
// vs._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
// vs._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
// vs.html = rs(vs.html, "i").replace("comment", vs._comment).replace("tag", vs._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
// vs.paragraph = rs(vs._paragraph).replace("hr", vs.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", vs._tag).getRegex(),
...
// vs.gfm.paragraph = rs(vs._paragraph).replace("hr", vs.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("table", vs.gfm.table).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", vs._tag).getRegex(),
// vs.pedantic = {
//     ...vs.normal,
//     html: rs("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", vs._comment).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),
//     def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,
//     heading: /^(#{1,6})(.*)(?:\n+|$)/,
//     fences: ps,
//     lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
//     paragraph: rs(vs.normal._paragraph).replace("hr", vs.hr).replace("heading", " *#{1,6} *[^\n]").replace("lheading", vs.lheading).replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").getRegex()
// };
// const ys = {
//     escape: /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,
...
// }
// ys._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",
// ys.punctuation = rs(ys.punctuation).replace(/punctuation/g, ys._punctuation).getRegex(),
// ys.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,
// ys.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g,
...
//         endUnd: /_(?!_)/g
//     },
//     link: rs(/^!?\[(label)\]\((.*?)\)/).replace("label", ys._label).getRegex(),
//     reflink: rs(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", ys._label).getRegex()
// },
// ys.gfm = {
//     ...ys.normal,
...
//     text: rs(ys.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
// };
// class bs {
//     constructor(e) {
//         this.tokens = [],
...
//             inline: ys.normal
//         };
//         this.options.pedantic ? (t.block = vs.pedantic,
//         t.inline = ys.pedantic) : this.options.gfm && (t.block = vs.gfm,
...
//                     e.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (a = a.slice(0, i.index) + "[" + fs("a", i[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
//         }
...
//     }
//     parse(e, t=!0) {
//         let n, r, l, i, s, o, a, c, u, p, d, h, f, g, m, v, y, w, k, b = "";
//         const x = e.length;
//         for (n = 0; n < x; n++)
//             if (p = e[n],
//             this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type] && (k = this.options.extensions.renderers[p.type].call({
//                 parser: this
//             }, p),
...
//                     i = p.header.length,
//                     r = 0; r < i; r++)
//                         a += this.renderer.tablecell(this.parseInline(p.header[r].tokens), {
//                             header: !0,
//                             align: p.align[r]
//                         });
...
//                         y = m.task,
//                         g = "",
//                         m.task && (w = this.renderer.checkbox(v),
//                         f ? m.tokens.length > 0 && "paragraph" === m.tokens[0].type ? (m.tokens[0].text = w + " " + m.tokens[0].text,
//                         m.tokens[0].tokens && m.tokens[0].tokens.length > 0 && "text" === m.tokens[0].tokens[0].type && (m.tokens[0].tokens[0].text = w + " " + m.tokens[0].tokens[0].text)) : m.tokens.unshift({
//                             type: "text",
//                             text: w
//                         }) : g += w),
...
//         for (n = 0; n < s; n++)
//             if (r = e[n],
//             this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[r.type] && (l = this.options.extensions.renderers[r.type].call({
//                 parser: this
//             }, r),
...
//                 return a();
//             let c = 0;
//             return Rs.walkTokens(o, (function(e) {
//                 "code" === e.type && (c++,
//                 setTimeout((()=>{
...
//         }
//         if (r.async)
//             return Promise.resolve(r.hooks ? r.hooks.preprocess(n) : n).then((t=>e(t, r))).then((e=>r.walkTokens ? Promise.all(Rs.walkTokens(e, r.walkTokens)).then((()=>e)) : e)).then((e=>t(e, r))).then((e=>r.hooks ? r.hooks.postprocess(e) : e)).catch(s);
//         try {
//             r.hooks && (n = r.hooks.preprocess(n));
//             const l = e(n, r);
//             r.walkTokens && Rs.walkTokens(l, r.walkTokens);
//             let i = t(l, r);
//             return r.hooks && (i = r.hooks.postprocess(i)),
//             i
//         } catch (e) {
//             return s(e)
//         }
...
// }
// Rs.options = Rs.setOptions = function(e) {
//     var t;
//     return Rs.defaults = {
//         ...Rs.defaults,
//         ...e
...
// Rs.defaults = qi,
// Rs.use = function(...e) {
//     const t = Rs.defaults.extensions || {
//         renderers: {},
//         childTokens: {}
//     };
//     e.forEach((e=>{
...
//             ...e
//         };
//         if (n.async = Rs.defaults.async || n.async || !1,
...
//                 const r = t[n];
//                 Ss.passThroughHooks.has(n) ? t[n] = l=>{
//                     if (Rs.defaults.async)
//                         return Promise.resolve(e.hooks[n].call(t, l)).then((e=>r.call(t, e)));
...
//                 let r = [];
//                 return r.push(e.walkTokens.call(this, n)),
...
//     let n = [];
//     for (const r of e)
//         switch (n = n.concat(t.call(Rs, r)),
//         r.type) {
//         case "table":
//             for (const e of r.header)
//                 n = n.concat(Rs.walkTokens(e.tokens, t));
//             for (const e of r.rows)
//                 for (const r of e)
//                     n = n.concat(Rs.walkTokens(r.tokens, t));
//             break;
//         case "list":
//             n = n.concat(Rs.walkTokens(r.items, t));
//             break;
//         default:
//             Rs.defaults.extensions && Rs.defaults.extensions.childTokens && Rs.defaults.extensions.childTokens[r.type] ? Rs.defaults.extensions.childTokens[r.type].forEach((function(e) {
...
//     return i.length && (({serverURL: e, lang: t, paths: n, signal: r})=>fetch(`${e}/comment?type=count&url=${encodeURIComponent(n.join(","))}&lang=${t}`, {
//         signal: r
...
// var Xs = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}
//   , Ys = {}
//   , eo = {}
//   , to = {}
//   , no = Xs && Xs.__awaiter || function(e, t, n, r) {
...
//     ))
// }
//   , ro = Xs && Xs.__generator || function(e, t) {
//     var n, r, l, i, s = {
//         label: 0,
//         sent: function() {
//             if (1 & l[0])
...
//                     try {
//                         if (n = 1,
//                         r && (l = 2 & i[0] ? r.return : i[0] ? r.throw || ((l = r.return) && l.call(r),
//                         0) : r.next) && !(l = l.call(r, i[1])).done)
//                             return l;
//                         switch (r = 0,
//                         l && (i = [2 & i[0], l.value]),
//                         i[0]) {
...
//         null === this.styleContainer && (this.styleContainer = document.createElement("style"),
//         this.styleContainer.innerHTML = ".grecaptcha-badge{visibility:hidden !important;}",
//         document.head.appendChild(this.styleContainer))
//     }
//     ,
//     e.prototype.showBadge = function() {
//         null !== this.styleContainer && (document.head.removeChild(this.styleContainer),
//         this.styleContainer = null)
//     }
//     ,
//     e
...
//             return t !== e.instanceSiteKey ? Promise.reject(new Error("reCAPTCHA already loaded with different site key!")) : new Promise((function(t, n) {
...
//                 e.setLoadingState(io.NOT_LOADED),
//                 n(t)
//             }
//             ,
...
//                             signal: s.signal
//                         });
//                         if (Array.isArray(o) || "number" == typeof o)
//                             return;
...
//         )),
//         er((()=>c?.())),
//         (e,t)=>a.value.length ? (Gr(),
//         Yr("div", po, [sl("div", {
//             class: "wl-reaction-title",
//             textContent: Ie(s.value.reactionTitle)
//         }, null, 8, ho), sl("ul", fo, [(Gr(!0),
//         Yr(Hr, null, ir(a.value, (({active: e, icon: t, desc: s},o)=>(Gr(),
//         Yr("li", {
//             key: o,
...
// }
// var So = null;
// "undefined" == typeof window ? ((So = function(e) {
//     return e
// }
// ).destroy = function(e) {
//     return e
...
//                 var t, n = null, r = window.getComputedStyle(e), l = (t = e.value,
//                 function() {
//                     s({
...
//             }
//             function s(t) {
//                 var l, i, o = t.restoreTextAlign, a = void 0 === o ? null : o, c = t.testForHeightReduction, u = void 0 === c || c, p = r.overflowY;
//                 if (0 !== e.scrollHeight && ("vertical" === r.resize ? e.style.resize = "none" : "both" === r.resize && (e.style.resize = "horizontal"),
//                 u && (l = function(e) {
...
//                 }(e),
//                 e.style.height = ""),
//                 i = "content-box" === r.boxSizing ? e.scrollHeight - (parseFloat(r.paddingTop) + parseFloat(r.paddingBottom)) : e.scrollHeight + parseFloat(r.borderTopWidth) + parseFloat(r.borderBottomWidth),
//                 "none" !== r.maxHeight && i > parseFloat(r.maxHeight) ? ("hidden" === r.overflowY && (e.style.overflow = "scroll"),
//                 i = parseFloat(r.maxHeight)) : "hidden" !== r.overflowY && (e.style.overflow = "hidden"),
//                 e.style.height = i + "px",
//                 a && (e.style.textAlign = a),
//                 l && l(),
//                 n !== i && (e.dispatchEvent(new Event("autosize:resized",{
//                     bubbles: !0
//                 })),
//                 n = i),
//                 p !== r.overflow && !a)) {
...
// ,
// So.update = function(e) {
//     return e && Array.prototype.forEach.call(e.length ? e : [e], Co),
//     e
// }
// );
// var Ao = So;
...
//             s.value[Number(t.dataset.index)].push(e),
//             await a(e + 1)
//         }
//           , c = async(e=!1)=>{
//             if (s.value.length === o() && !e)
//                 return;
//             var t;
//             s.value = (t = o(),
...
//             })
//         }, [(Gr(!0),
//         Yr(Hr, null, ir(t, (t=>(Gr(),
//         Yr(Hr, {
//             key: t
//         }, [i.value[e.items[t].src] ? ul("v-if", !0) : (Gr(),
//         el(on(qs), {
//             key: 0,
//             size: 36,
//             style: {
...
//             return j(t),
//             E.value = !0,
//             Promise.resolve().then((()=>l.value.imageUploader(e))).then((n=>{
...
//           , V = ()=>{
//             const e = u.value;
//             e.files && T.value && M(e.files[0]).then((()=>{
//                 e.value = ""
//             }
//             ))
//         }
...
//                     return a.value.nick?.focus(),
//                     alert(L.value.nickError);
//                 if (d.indexOf("mail") > -1 && !v.mail || v.mail && (y = v.mail,
//                 !O.test(y)))
//                     return a.value.mail?.focus(),
...
//             if (v.comment) {
//                 if (!S.value)
//                     return alert(L.value.wordHint.replace("$0", p[0].toString()).replace("$1", p[1].toString()).replace("$2", x.value.toString()));
//                 v.comment = Is(v.comment, m.value.map),
//                 r.replyId && r.rootId && (v.pid = r.replyId,
//                 v.rid = r.rootId,
//                 v.at = r.replyUser),
//                 E.value = !0;
//                 try {
//                     h && (v.recaptchaV3 = await (e=>{
//                         const t = ao[e] ?? (ao[e] = Ys.load(e, {
//                             useRecaptchaNet: !0,
//                             autoHideBadge: !0
//                         }));
//                         return {
...
//                     }
//                     )(h).execute("social")),
//                     f && (v.turnstile = await (w = f,
//                     {
//                         execute: async e=>{
//                             const {load: t} = Mi("https://challenges.cloudflare.com/turnstile/v0/api.js", void 0, {
//                                 async: !1
//                             });
//                             await t();
...
//                 new Promise((e=>{
//                     const t = ({data: n})=>{
//                         n && "object" == typeof n && "userInfo" === n.type && n.data.token && (l?.close(),
...
//               , s = l.value.search
//               , o = g.value?.value || "";
//             if (i < .9 || _.loading || z.value)
//                 return;
//             _.loading = !0;
//             (s.more && _.list.length ? await s.more(o, _.list.length) : await s.search(o)).length ? _.list = [..._.list, ...s.more && _.list.length ? await s.more(o, _.list.length) : await s.search(o)] : z.value = !0,
//             _.loading = !1,
//             setTimeout((()=>{
...
//         Hn([l, x], (([e,t])=>{
//             const {wordLimit: n} = e;
//             n ? t < n[0] && 0 !== n[0] ? ($.value = n[0],
//             S.value = !1) : t > n[1] ? ($.value = n[1],
//             S.value = !1) : ($.value = n[1],
//             S.value = !0) : ($.value = 0,
//             S.value = !0)
//         }
...
//                     texRenderer: n
//                 }),
//                 x.value = (e=>((e=>e.match(/[\w\d\s,.\u00C0-\u024F\u0400-\u04FF]+/giu))(e)?.reduce(((e,t)=>e + ("" === t.trim() ? 0 : t.trim().split(/\s+/u).length)), 0) || 0) + ((e=>e.match(/[\u4E00-\u9FD5]/gu))(e)?.length || 0))(e),
...
//         )),
//         (e,t)=>(Gr(),
//         Yr("div", Io, ["disable" !== on(l).login && I.value && !e.edit?.objectId ? (Gr(),
//         Yr("div", To, [sl("div", jo, [sl("button", {
//             type: "submit",
//             class: "wl-logout-btn",
...
//         }, null, 8, Po)])) : ul("v-if", !0), sl("div", Fo, ["force" !== on(l).login && on(l).meta.length && !I.value ? (Gr(),
//         Yr("div", {
//             key: 0,
//             class: Ae(["wl-header", `item${on(l).meta.length}`])
//         }, [(Gr(!0),
//         Yr(Hr, null, ir(on(l).meta, (e=>(Gr(),
//         Yr("div", {
//             key: e,
//             class: "wl-header-item"
//         }, [sl("label", {
//             for: `wl-${e}`,
//             textContent: Ie(L.value[e] + (on(l).requiredMeta.includes(e) || !on(l).requiredMeta.length ? "" : `(${L.value.optional})`))
//         }, null, 8, Vo), qn(sl("input", {
//             id: `wl-${e}`,
//             ref_for: !0,
//             ref: t=>{
//                 t && (a.value[e] = t)
...
//         }, null, 10, No), [[oi, on(s)[e]]])])))), 128))], 2)) : ul("v-if", !0), qn(sl("textarea", {
//             id: "wl-edit",
//             ref_key: "editorRef",
//             ref: c,
...
//             onDrop: P,
//             onPaste: F
//         }, null, 40, Do), [[Yl, on(i)]]), qn(sl("div", Ho, [Bo, sl("h4", null, Ie(L.value.preview) + ":", 1), sl("div", {
//             class: "wl-content",
//             innerHTML: b.value
//         }, null, 8, Wo)], 512), [[ci, k.value]]), sl("div", qo, [sl("div", Zo, [sl("a", Ko, [ol(on(Ds))]), qn(sl("button", {
...
//         }, [ol(on(Ps))], 10, Go), [[ci, m.value.tabs.length]]), on(l).search ? (Gr(),
//         Yr("button", {
//             key: 0,
...
//         }, [ol(on(Zs))], 10, Qo)) : ul("v-if", !0), sl("input", {
//             id: "wl-image-upload",
...
//         }, [ol(on(Fs))], 8, Jo)) : ul("v-if", !0), sl("button", {
//             type: "button",
//             class: Ae(["wl-action", {
//                 active: k.value
//             }]),
...
//         }, [ol(on(Ns))], 10, Xo)]), sl("div", Yo, [ea, sl("div", ta, [cl(Ie(x.value) + " ", 1), on(l).wordLimit ? (Gr(),
//         Yr("span", na, [cl("  /  "), sl("span", {
//             class: Ae({
//                 illegal: !S.value
//             }),
//             textContent: Ie($.value)
//         }, null, 10, ra)])) : ul("v-if", !0), cl("  " + Ie(L.value.word), 1)]), "disable" === on(l).login || I.value ? ul("v-if", !0) : (Gr(),
//         Yr("button", {
//             key: 0,
//             type: "button",
//             class: "wl-btn",
...
//         }, null, 8, la)), "force" !== on(l).login || I.value ? (Gr(),
//         Yr("button", {
//             key: 1,
//             type: "submit",
...
//         Yr(Hr, {
//             key: 1
//         }, [cl(Ie(L.value.submit), 1)], 64))], 8, ia)) : ul("v-if", !0)]), sl("div", {
//             ref_key: "gifPopupRef",
//             ref: f,
...
//             onScroll: q
//         }, null, 8, ["items"])) : ul("v-if", !0), _.loading ? (Gr(),
//         Yr("div", oa, [ol(on(qs), {
//             size: 30
//         })])) : ul("v-if", !0)], 2), sl("div", {
...
//             }])
//         }, [(Gr(!0),
//         Yr(Hr, null, ir(m.value.tabs, ((e,t)=>(Gr(),
//         Yr(Hr, {
//             key: e.name
//         }, [t === v.value ? (Gr(),
//         Yr("div", aa, [(Gr(!0),
//         Yr(Hr, null, ir(e.items, (e=>(Gr(),
//         Yr("button", {
//             key: e,
//             type: "button",
//             title: e,
...
//         }, null, 8, ua)) : ul("v-if", !0)], 8, ca)))), 128))])) : ul("v-if", !0)], 64)))), 128)), m.value.tabs.length > 1 ? (Gr(),
//         Yr("div", pa, [(Gr(!0),
//         Yr(Hr, null, ir(m.value.tabs, ((e,t)=>(Gr(),
//         Yr("button", {
//             key: e.name,
...
//             loading: "lazy",
//             referrerPolicy: "no-referrer"
//         }, null, 8, ha)], 10, da)))), 128))])) : ul("v-if", !0)], 2)])]), e.replyId || e.edit?.objectId ? (Gr(),
//         Yr("button", {
//             key: 1,
//             type: "button",
//             class: "wl-close",
...
//                 class: "wl-card-item"
//             }, [sl("div", ya, [e.comment.avatar ? (Gr(),
//             Yr("img", {
//                 key: 0,
//                 src: e.comment.avatar
//             }, null, 8, wa)) : ul("v-if", !0), e.comment.type ? (Gr(),
//             el(on(Ws), {
//                 key: 1
//             })) : ul("v-if", !0)]), sl("div", ka, [sl("div", ba, [a.value ? (Gr(),
//             Yr("a", {
//                 key: 0,
//                 class: "wl-nick",
//                 href: a.value,
...
//             }, Ie(e.comment.nick), 9, xa)) : (Gr(),
//             Yr("span", _a, Ie(e.comment.nick), 1)), "administrator" === e.comment.type ? (Gr(),
//             Yr("span", {
//                 key: 2,
//                 class: "wl-badge",
//                 textContent: Ie(o.value.admin)
//             }, null, 8, $a)) : ul("v-if", !0), e.comment.label ? (Gr(),
//             Yr("span", {
//                 key: 3,
//                 class: "wl-badge",
//                 textContent: Ie(e.comment.label)
//             }, null, 8, Ca)) : ul("v-if", !0), e.comment.sticky ? (Gr(),
//             Yr("span", {
//                 key: 4,
//                 class: "wl-badge",
//                 textContent: Ie(o.value.sticky)
//             }, null, 8, Sa)) : ul("v-if", !0), void 0 !== e.comment.level && e.comment.level >= 0 ? (Gr(),
//             Yr("span", {
//                 key: 5,
//                 class: Ae(`wl-badge level${e.comment.level}`),
//                 textContent: Ie(o.value[`level${e.comment.level}`] || `Level ${e.comment.level}`)
//             }, null, 10, Aa)) : ul("v-if", !0), sl("span", {
//                 class: "wl-time",
//                 textContent: Ie(u.value)
//             }, null, 8, Ra), sl("div", Ea, [p.value || d.value ? (Gr(),
//             Yr("button", {
//                 key: 0,
//                 type: "button",
//                 class: "wl-edit",
//                 onClick: t[0] || (t[0] = ()=>e.$emit("edit", e.comment))
//             }, [ol(on(Bs))])) : ul("v-if", !0), p.value || d.value ? (Gr(),
//             Yr("button", {
//                 key: 1,
//                 type: "button",
//                 class: "wl-delete",
//                 onClick: t[1] || (t[1] = t=>e.$emit("delete", e.comment))
//             }, [ol(on(Ms))])) : ul("v-if", !0), sl("button", {
//                 type: "button",
//                 class: "wl-like",
...
//             }, [ol(on(Vs), {
//                 active: c.value
//             }, null, 8, ["active"]), "like"in e.comment ? (Gr(),
//             Yr("span", {
//                 key: 0,
//                 textContent: Ie(e.comment.like)
//             }, null, 8, La)) : ul("v-if", !0)], 8, za), sl("button", {
//                 type: "button",
//                 class: Ae(["wl-reply", {
//                     active: h.value
//                 }]),
...
//             }, [ol(on(Hs))], 10, Ia)])]), sl("div", Ta, [e.comment.addr ? (Gr(),
//             Yr("span", {
//                 key: 0,
//                 class: "wl-addr",
//                 "data-value": e.comment.addr,
//                 textContent: Ie(e.comment.addr)
//             }, null, 8, ja)) : ul("v-if", !0), e.comment.browser ? (Gr(),
//             Yr("span", {
//                 key: 1,
//                 class: "wl-browser",
//                 "data-value": e.comment.browser,
//                 textContent: Ie(e.comment.browser)
//             }, null, 8, Oa)) : ul("v-if", !0), e.comment.os ? (Gr(),
//             Yr("span", {
//                 key: 2,
//                 class: "wl-os",
//                 "data-value": e.comment.os,
//                 textContent: Ie(e.comment.os)
//             }, null, 8, Ua)) : ul("v-if", !0)]), f.value ? ul("v-if", !0) : (Gr(),
//             Yr("div", {
//                 key: 0,
//                 class: "wl-content",
//                 innerHTML: e.comment.comment
//             }, null, 8, Ma)), p.value && !f.value ? (Gr(),
//             Yr("div", Pa, [sl("span", Fa, [(Gr(),
//             Yr(Hr, null, ir(n, (t=>sl("button", {
//                 key: t,
//                 type: "submit",
...
//             }, null, 10, Va))), 64))]), p.value && !e.comment.rid ? (Gr(),
//             Yr("button", {
//                 key: 0,
//                 type: "submit",
//                 class: "wl-btn wl-sticky",
//                 onClick: t[4] || (t[4] = t=>e.$emit("sticky", e.comment))
//             }, Ie(e.comment.sticky ? o.value.unsticky : o.value.sticky), 1)) : ul("v-if", !0)])) : ul("v-if", !0), h.value || f.value ? (Gr(),
//             Yr("div", {
//                 key: 2,
//                 class: Ae({
...
//             }, null, 8, ["edit", "reply-id", "reply-user", "root-id"])], 2)) : ul("v-if", !0), e.comment.children ? (Gr(),
//             Yr("div", Na, [(Gr(!0),
//             Yr(Hr, null, ir(e.comment.children, (n=>(Gr(),
//             el(r, {
//                 key: n.objectId,
//                 comment: n,
//                 reply: e.reply,
...
//               , u = ()=>{
//                 r && n.value && (a(),
//                 r.head.removeChild(r.getElementById(s)),
//                 n.value = !1)
//             }
//             ;
//             l && !i && $i(c),
...
//                 fetch(`${e}/comment?path=${encodeURIComponent(n)}&pageSize=${l}&page=${r}&lang=${t}&sortBy=${i}`, {
//                     signal: s,
//                     headers: a
//                 }).then((e=>e.json())).then((e=>x(e, "Get comment data")))
//             }
//             )({
//                 serverURL: t,
//                 lang: y.value.lang,
...
//                 return;
//             const {serverURL: t, lang: n} = y.value;
//             await (({serverURL: e, lang: t, token: n, objectId: r})=>fetch(`${e}/comment/${r}?lang=${t}`, {
//                 method: "DELETE",
//                 headers: {
//                     Authorization: `Bearer ${n}`
//                 }
//             }).then((e=>e.json())).then((e=>x(e, "Delete comment"))))({
//                 serverURL: t,
//                 lang: n,
//                 token: d.value?.token,
//                 objectId: e
//             }),
//             b.value.some(((t,n)=>t.objectId === e ? (b.value = b.value.filter(((e,t)=>t !== n)),
//             !0) : t.children.some(((r,l)=>r.objectId === e && (b.value[n].children = t.children.filter(((e,t)=>t !== l)),
//             !0)))))
//         }
//           , H = async e=>{
//             const {serverURL: t, lang: n} = y.value
...
//                 }
//             }),
//             l ? h.value = h.value.filter((e=>e !== r)) : (h.value = [...h.value, r],
...
//                 r === n && (n = vl.provides = Object.create(r)),
//                 n[e] = t
//             }
//         }("config", y),
//         Xn((()=>{
...
//         er((()=>T?.())),
//         (e,t)=>(Gr(),
//         Yr("div", Ba, [ol(xo), _.value ? ul("v-if", !0) : (Gr(),
//         el(ma, {
//             key: 0,
//             onLog: U,
//             onSubmit: F
//         })), sl("div", Wa, [sl("div", qa, [g.value ? (Gr(),
//         Yr("span", {
//             key: 0,
//             class: "wl-num",
//             textContent: Ie(g.value)
//         }, null, 8, Za)) : ul("v-if", !0), cl(" " + Ie(R.value.comment), 1)]), sl("ul", Ka, [(Gr(!0),
//         Yr(Hr, null, ir(on(u), (e=>(Gr(),
//         Yr("li", {
//             key: e,
...
//             }
//             )(e)
//         }, Ie(R.value[e]), 11, Ga)))), 128))])]), sl("div", Qa, [(Gr(!0),
//         Yr(Hr, null, ir(b.value, (e=>(Gr(),
//         el(Da, {
//             key: e.objectId,
//             "root-id": e.objectId,
//             comment: e,
...
//             onSticky: N,
//             onLike: H
//         }, null, 8, ["root-id", "comment", "reply", "edit"])))), 128))]), "error" === f.value ? (Gr(),
//         Yr("div", Ja, [sl("button", {
//             type: "button",
//             class: "wl-btn",
//             onClick: U,
...
//         Yr("div", Ya, [ol(on(qs), {
//             size: 30
//         })])) : b.value.length ? m.value < v.value ? (Gr(),
//         Yr("div", tc, [sl("button", {
//             type: "button",
//             class: "wl-btn",
//             onClick: O,
//             textContent: Ie(R.value.more)
//         }, null, 8, nc)])) : ul("v-if", !0) : (Gr(),
//         Yr("div", {
//             key: 1,
//             class: "wl-empty",
//             textContent: Ie(R.value.sofa)
//         }, null, 8, ec))], 64)), y.value.copyright ? (Gr(),
//         Yr("div", rc, [cl(" Powered by "), lc, cl(" v" + Ie(on(Ha)), 1)])) : ul("v-if", !0)]))
//     }
// })
...
//         return null !== n && t !== n
//     }
//       , a = n=>(({serverURL: e, lang: t, paths: n, signal: r})=>_({
//         serverURL: e,
//         lang: t,
//         paths: n,
//         type: ["time"],
...
//             type: "time",
//             action: "inc"
//         })).then((e=>oc(new Array(n.length).fill(e), n))),
//         r.length && a(r)
//     } else
//         a(s);
//     var c;
...
//         const i = {};
//         return l && (i.Authorization = `Bearer ${l}`),
...
//     return (({serverURL: e, signal: t, pageSize: n, lang: r})=>fetch(`${e}/user?pageSize=${n}&lang=${r}`, {
//         signal: t
//     }).then((e=>e.json())).then((e=>x(e, "user list"))).then((e=>e.data)))({
//         serverURL: t,
//         pageSize: n,
//         lang: i,
//         signal: a.signal
